...
<body>
	<%
        ...
        /* 글 수정시 넘어온 값(request를 통해)들을 체크함 */
        else{
			if(request.getParameter("bbsTitle") == null || request.getParameter("bbsContent") == null
					...
					int result = bbsDAO.update(bbsID, request.getParameter("bbsTitle"), request.getParameter("bbsContent")); /* bbsDAO 선언한 update 매서드에 값 넘겨줌 */
